---
name: linear
description: Linear issue management. MUST trigger when: (1) user mentions LOBE-xxx issue IDs, (2) creating PRs that reference Linear issues, (3) completing tasks linked to Linear issues. Auto-activate on PR creation with issue references to add completion comments.
---
