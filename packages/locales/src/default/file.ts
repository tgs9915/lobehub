export default {
  ...
  'pageEditor.history.compareDescription':
    'Comparing the current content with the selected history state',
  ...
  'pageEditor.history.restoreConfirm.content':
    'Restore the page to how it was at {{savedAt}}? Your current content will be replaced and saved.',
